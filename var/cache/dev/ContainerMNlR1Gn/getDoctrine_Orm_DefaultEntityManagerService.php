...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\IngrdientRepository' => ['privates', 'App\\Repository\\IngrdientRepository', 'getIngrdientRepositoryService', true],
            'App\\Repository\\RecetteIngrdientRepository' => ['privates', 'App\\Repository\\RecetteIngrdientRepository', 'getRecetteIngrdientRepositoryService', true],
            'App\\Repository\\RecetteRepository' => ['privates', 'App\\Repository\\RecetteRepository', 'getRecetteRepositoryService', true],
            'App\\Repository\\UserGuardRepository' => ['privates', 'App\\Repository\\UserGuardRepository', 'getUserGuardRepositoryService', true],
        ], [
            'App\\Repository\\IngrdientRepository' => '?',
            'App\\Repository\\RecetteIngrdientRepository' => '?',
            'App\\Repository\\RecetteRepository' => '?',
            'App\\Repository\\UserGuardRepository' => '?',
        ])));
