 ...
 */
class getIngrdientRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\IngrdientRepository' shared autowired service.
     *
     * @return \App\Repository\IngrdientRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IngrdientRepository.php';

        return $container->privates['App\\Repository\\IngrdientRepository'] = new \App\Repository\IngrdientRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
