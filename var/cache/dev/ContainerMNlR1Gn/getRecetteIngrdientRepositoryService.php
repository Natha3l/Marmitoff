 ...
 */
class getRecetteIngrdientRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RecetteIngrdientRepository' shared autowired service.
     *
     * @return \App\Repository\RecetteIngrdientRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RecetteIngrdientRepository.php';

        return $container->privates['App\\Repository\\RecetteIngrdientRepository'] = new \App\Repository\RecetteIngrdientRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
