 ...
 */
class getUserGuardRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserGuardRepository' shared autowired service.
     *
     * @return \App\Repository\UserGuardRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserGuardRepository.php';

        return $container->privates['App\\Repository\\UserGuardRepository'] = new \App\Repository\UserGuardRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
