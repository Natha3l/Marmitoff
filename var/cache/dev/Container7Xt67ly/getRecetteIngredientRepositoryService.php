 ...
 */
class getRecetteIngredientRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RecetteIngredientRepository' shared autowired service.
     *
     * @return \App\Repository\RecetteIngredientRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RecetteIngredientRepository.php';

        return $container->privates['App\\Repository\\RecetteIngredientRepository'] = new \App\Repository\RecetteIngredientRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
